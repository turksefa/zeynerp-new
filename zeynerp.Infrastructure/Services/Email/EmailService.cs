...
namespace zeynerp.Infrastructure.Services.Email
{
    public class EmailService : IEmailService
    {
        ...
        public Task<bool> SendInvitationEmailAsync(string to, string userName, string invitationLink)
        {
            var subject = "Davet";
            var body = $@"
            <html>
            <body>
                <h2>Merhaba {userName},</h2>
                <p>Sizi uygulamamıza davet ediyoruz. Aşağıdaki bağlantıya tıklayarak davetinizi kabul edebilirsiniz:</p>
                <a href='{invitationLink}' style='background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Davet Kabul Et</a>
                <p>Eğer bu daveti beklemiyorduysanız, lütfen bu e-postayı görmezden gelin.</p>
                <br>
                <p>Teşekkürler,<br>Uygulama Ekibi</p>
            </body>
            </html>";
